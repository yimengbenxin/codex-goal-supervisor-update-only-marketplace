...
Candidate under test: `2.8.10+codex.20260817054749`
...
| 2.8.10 | Release selftest Goal isolation | deterministic + real-host trap | Package selftest forces the native bridge off even when the launching Codex task exports a real thread id and an enabled bridge; a trap executable proves the host Goal is never read or replaced. | PASS |
